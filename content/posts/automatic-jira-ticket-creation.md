...
anchor: "Automating Jira Ticket Creation with Python"
type: "post"
---
...
description: This is an automatically generated stub!

[UpgradeSection]
summary: rel-{0}: Upgrade from {1} on {2} cloud.
description: This is a automatically generated stub!
```
...
```
summary: rel-{0}: {1} test on {2} config with {3} provider
description: Run the {0} test suite with the {1} option enabled on {2}
```
Then process those like so:
```
ticket.format_summary("1.0.0", "regression", "secure", "aws")
ticket.format_description("regression", "secure", "aws")
```
...
[**Download Here**](https://github.com/austinlparker/ticketgen)